...
public class GuiConstants {
    ...
    //SOUNDS
    public static final File CAPTURE_SOUND = new File("sounds/capture.wav");
    public static final File PROMOTE_SOUND = new File("sounds/promote.wav");
    public static final File MOVE_SOUND = new File("sounds/move.wav");
    public static final File CHECK_SOUND = new File("sounds/check.wav");
    public static final File ILLEGAL_SOUND = new File("sounds/illegal.wav");
    public static final File START_SOUND = new File("sounds/game-start.wav");
    public static final File END_SOUND = new File("sounds/game-end.wav");
    public static final File CASTLE_SOUND = new File("sounds/castle.wav");
